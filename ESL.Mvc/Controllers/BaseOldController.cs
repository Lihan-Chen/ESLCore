...
{
    public class BaseOldController : Controller
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public BaseOldController(IHttpContextAccessor httpContextAccessor)
        {
