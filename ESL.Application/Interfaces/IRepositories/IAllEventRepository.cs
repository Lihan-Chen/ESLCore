...
namespace ESL.Application.Interfaces.IRepositories
{
    public interface IAllEventRepository // : IEventRepository<AllEvent>
    {
        ...
        public IQueryable<Current_AllEvent> GetListQuery(int? facilNo, int? logTypeNo, string strStartDate, string strEndDate, string strSearch, string strOperatorType);
