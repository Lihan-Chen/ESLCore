...
#pragma warning restore CS8629 // Nullable value type may be null.
                            break;
                        case "Test Release":
                            _EventTrail += "Test Released by: " + ReleasedBy != null ? "ReleasedBy_Employee.FullName" : "n/a" + _CrLf; // +"Test Released to: " + ReleasedTo + _CrLf;
                            _EventTrail += $"Test Released Dt/Tm: {ReleasedDate.Value.ToString("MM/dd/yyyy")} {ReleasedTime}{_CrLf}";
#pragma warning restore CS8629 // Nullable value type may be null.
                            break;
                        case "Transfer":
                            _EventTrail += "Transferred by: " + ReleasedBy != null ? "ReleasedBy_Employee.FullName" : "n/a" + _CrLf; // +"Released to: " + ReleasedTo + _CrLf;
